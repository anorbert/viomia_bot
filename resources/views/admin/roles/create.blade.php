...
<div class="vi-form-container">
    <div class="vi-header">
        <div>
            ...
            <div class="vi-header-title">Create New Role</div>
            <div class="vi-header-sub">Add a new user role to the system</div>
        </div>
    ...
    <div class="vi-panel">
        <div class="vi-panel-title"><i class="fa fa-plus-circle"></i> Role Details</div>
        ...
        <form method="POST" action="{{ route('admin.roles.store') }}">
            ...
            <div class="vi-form-group">
                ...
                <input type="text" name="name" class="vi-form-input @error('name') is-invalid @enderror"
                       placeholder="e.g., moderator, content-manager"
                       value="{{ old('name') }}" required autofocus>
                @error('name')<div class="vi-error"><i class="fa fa-exclamation-circle"></i> {{ $message }}</div>@enderror
                <div class="vi-form-hint"><i class="fa fa-info-circle"></i> Must be unique and lowercase (e.g., support, admin, user)</div>
            </div>
            ...
            <div class="vi-form-group">
                ...
                <select name="status" class="vi-form-select @error('status') is-invalid @enderror" required>
                    <option value="Active" {{ old('status', 'Active') === 'Active' ? 'selected' : '' }}>Active (Users can be assigned)</option>
