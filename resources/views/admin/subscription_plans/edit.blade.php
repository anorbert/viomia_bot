...
<div class="vi-header">
    <div>
        ...
        <div class="vi-header-title">Edit Plan: {{ $plan->name }}</div>
        <div class="vi-header-sub">Update subscription tier details and features</div>
    </div>
        ...
        <div style="padding: 20px;">
            ...
            <div class="vi-grid">
                <div class="vi-form-group">
                    ...
                    <input type="text" class="vi-form-input" name="name" value="{{ old('name', $plan->name) }}" placeholder="e.g., Professional Plan" required>
                </div>

                <div class="vi-form-group">
                    <label class="vi-form-label">Plan Slug *</label>
                    <input type="text" class="vi-form-input" name="slug" value="{{ old('slug', $plan->slug) }}" placeholder="e.g., professional-plan" pattern="[a-z0-9-]+" required>
            ...
            <div class="vi-form-group">
                ...
                <textarea class="vi-form-textarea" name="description" placeholder="Brief description of what this plan offers...">{{ old('description', $plan->description) }}</textarea>
            </div>
        ...
        <div style="padding: 20px;">
            ...
            <div class="vi-grid">
                <div class="vi-form-group">
                    ...
                    <input type="number" class="vi-form-input" name="price" value="{{ old('price', $plan->price) }}" step="0.01" min="0" placeholder="0.00" required>
                </div>

                <div class="vi-form-group">
                    <label class="vi-form-label">Currency *</label>
                    <input type="text" class="vi-form-input" name="currency" value="{{ old('currency', $plan->currency) }}" placeholder="USD" maxlength="10" required>
                </div>
                ...
                <div class="vi-form-group">
                    ...
                    <input type="number" class="vi-form-input" name="duration_days" value="{{ old('duration_days', $plan->duration_days) }}" min="1" placeholder="Leave blank for unlimited">
                </div>
            </div>
        ...
        <div style="padding: 20px;">
            ...
            <div class="vi-grid" style="grid-template-columns: repeat(auto-fit, minmax(150px, 1fr));">
                <div class="vi-form-group">
                    ...
                    <input type="number" class="vi-form-input" name="sort_order" value="{{ old('sort_order', $plan->sort_order) }}" min="0">
                </div>
            </div>
