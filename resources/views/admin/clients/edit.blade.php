...
<div class="vi-form-container">
    <div class="vi-header">
        <div>
            ...
            <div class="vi-header-title">Edit Client Account</div>
            <div class="vi-header-sub">Update client information and settings</div>
        </div>
    ...
    <div class="vi-panel">
        <div class="vi-panel-title"><i class="fa fa-user-circle"></i> Client Information</div>

        <div class="vi-info-box">
            <div class="vi-info-box-title">Client ID</div>
            <div class="vi-info-box-text">{{ $client->uuid }}</div>
        </div>

        <form method="POST" action="{{ route('admin.clients.update', $client->uuid) }}">
            @csrf
            @method('PUT')
            ...
            <div class="vi-form-row">
                ...
                <div class="vi-form-group">
                    ...
                    <div class="vi-form-hint"><i class="fa fa-info-circle"></i> Phone number is optional</div>
                </div>
            </div>

            <!-- Account Status & Details -->
            <div class="vi-panel-title" style="margin-top:24px;"><i class="fa fa-info-circle"></i> Account Details</div>

            <div class="vi-details-grid">
                <div class="vi-details-item">
                    <div class="vi-details-label">Status</div>
                    <div class="vi-details-value">
                        <span class="vi-status-badge {{ $client->trashed() ? 'vi-status-inactive' : 'vi-status-active' }}">
                            <i class="fa {{ $client->trashed() ? 'fa-times-circle' : 'fa-check-circle' }}"></i>
                            {{ $client->trashed() ? 'INACTIVE' : 'ACTIVE' }}
                        </span>
                    </div>
                </div>
                ...
                <div class="vi-details-item">
                    ...
                    <div class="vi-details-value"><i class="fa fa-calendar"></i> {{ $client->created_at->format('M j, Y') }}</div>
                </div>

                <div class="vi-details-item">
                    <div class="vi-details-label">Last Updated</div>
                    <div class="vi-details-value"><i class="fa fa-clock"></i> {{ $client->updated_at->format('M j, Y') }}</div>
                </div>
            </div>

            <div class="vi-info-box" style="margin-top:20px;">
                <div class="vi-info-box-title">Status Management</div>
                <div class="vi-info-box-text">To change account status, use the clients list page</div>
            </div>
